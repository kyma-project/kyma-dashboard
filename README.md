[![REUSE status](https://api.reuse.software/badge/github.com/kyma-project/kyma-dashboard)](https://api.reuse.software/info/github.com/kyma-project/kyma-dashboard)
